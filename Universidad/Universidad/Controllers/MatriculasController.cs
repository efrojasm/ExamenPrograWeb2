...
namespace Universidad.Controllers
{
    public class MatriculasController : Controller
    {
        ...
        {
            ViewBag.TotalMatricula = _context.Materia.Sum(x => x.Precio);
            ViewBag.CantMaterias = _context.Materia.Count();
           ...
           return View(await pARCIALDBContext.ToListAsync());
                ...
                // return View(await _context.Alumno.Where(m => m.Idalumno >0).ToListAsync());
        }
